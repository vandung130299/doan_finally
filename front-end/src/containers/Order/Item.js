...
function Item(props) {
  let { imageurl, productname, quantity, pricecurrent} = props.item;
  return (
    <div className="cart__item">
      ...
      <div className="cart__price">
        <span className="cart__price--current">{formatVnd(pricecurrent)}</span>
      </div>
      ...
      <div className="cart__total primary-color">
        {formatVnd(pricecurrent * quantity)}
      </div>
